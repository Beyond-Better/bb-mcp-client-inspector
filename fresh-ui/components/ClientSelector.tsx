...
import { wsMessages, sendCommand } from "../hooks/useWebSocket.ts";
...
export default function ClientSelector() {
  ...
  const selectedClientName = selectedMetadata?.clientInfo?.name || selectedClient?.sessionId;
      ...
      <div class="card-body">
        ...
        {clients.length === 0 ? (
          <div class="alert alert-info">
            ...
            <span>No clients connected. Start an MCP client and connect to the server.</span>
          </div>
        ) : (
          <details ref={detailsRef} class="dropdown dropdown-bottom w-full">
            <summary ref={summaryRef} class="btn btn-soft w-full justify-between">
              {selectedClient ? (
            ...
            <div ref={dropdownContentRef} class="dropdown-content z-[1] mt-2 w-full max-h-96 overflow-y-auto">
              <ul class="menu bg-base-100 rounded-box shadow-xl border border-base-300 p-2 w-full">
                {clients.map((client) => {
                  ...
                  const clientName = metadata?.clientInfo?.name || client.sessionId;
                      ...
                      >
                        <div class="flex items-start justify-between">
                          <div class="flex-1">
                            ...
                            {metadata?.lastMeta && (
                              <div class="mt-1">
                                <span class="badge badge-xs badge-outline">has _meta</span>
                              </div>
                            )}
                          </div>
