...
import type { ElicitationPayload, ElicitationSchema } from '@shared/types/index.ts';
import { formatZodError, validateElicitationPayload } from '@shared/types/index.ts';
  ...
  return (
    <div class='space-y-4'>
        ...
        <div class='join w-full'>
          <button
            ...
            class={`btn join-item flex-1 ${
              elicitationMode.value === 'approval' ? 'btn-primary' : 'btn-outline'
            }`}
      ...
      <div class='card-actions justify-end'>
        ...
        >
          {elicitationMode.value === 'approval' ? 'Request Approval' : 'Request Form Data'}
          <svg
            xmlns='http://www.w3.org/2000/svg'
            class='h-5 w-5'
            fill='none'
