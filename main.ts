...
async function launchMcpServer(options: LaunchOptions): Promise<Deno.ChildProcess> {
  console.log(`🚀 Starting MCP Server on ${options.mcpHost}:${options.mcpPort}...`);
...
async function launchFreshUi(options: LaunchOptions): Promise<Deno.ChildProcess> {
